STOP_WORDS = {
    ...
    'потому', 'этого', 'какой', 'совсем', 'ним', 'здесь', 'этом', 'одной',
    'почти', 'наш', 'тем', 'чтобы', 'нее', 'сейчас', 'были', 'куда', 'зачем',
    ...
    'такой', 'им', 'более', 'всегда', 'конечно', 'всю', 'между', 'узнать', 'хочу',
    'вгту'
}
...
REDUCTIONS_WORDS = {
    'мин.' : 'минимальный',
    'код' : 'номер',
    'заочка' : 'заочная форма обучения',
    'очка-заочка' : 'очно-заочная форма обучения',
    'очка' : 'очная форма обучения'
}